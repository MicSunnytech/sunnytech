            ...
            <div>
              <form ref={form} onSubmit={sendEmail} className="rounded-3xl border border-slate-200 p-6 bg-yellow-300 grid gap-8">
                ...
                <div className="grid gap-2">
                  ...
                  <input id="telefono" name="telefono" type="tel" required placeholder="+34 600 123 456" pattern="[0-9+ ]{9,15}" className="rounded-2xl border border-slate-300 px-4 py-2 outline-none focus:ring-2 ring-yellow-300"/>
                </div>
               ...
               {/* Dirección */}
                ...
                {/* Factura calefacción */}
                <div className="grid gap-2">
                  <label htmlFor="Factura_calefaccion" className="text-sm font-medium">Cuánto pagas de factura en invierno al mes</label>
                ...
                {/* Objetivo */}
                <div className="grid gap-2">
                  <label htmlFor="porque" className="text-sm font-medium">¿Cuál es tu objetivo?</label>
                  <select id="porque" name="porque" className="rounded-2xl border border-slate-300 px-4 py-2 outline-none focus:ring-2 ring-yellow-300">
                    <option value="">Selecciona...</option>
